...
Em cada requisito você encontrará uma imagem de um protótipo de como a aplicação deve resultar.
```javascript
...
- O  projeto deverá usar um `ORM` para criar e atualizar o seu banco. A clonagem do projeto seguida de um comando de migrate deve deixá-lo em sua forma esperada.
